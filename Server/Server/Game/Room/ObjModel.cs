...
namespace Server.Game
{
    public class ObjModel
    {
        ...
        public Vector3 GetRandomNavMeshPos()
        {
            int navIndex = new System.Random().Next(0, _meshTriangles.Count);
            NavMeshTriangle triangle = _meshTriangles[navIndex];
            Vector3 centerPos = (triangle.A + triangle.B + triangle.C) / 3;
            centerPos.y = 0;
