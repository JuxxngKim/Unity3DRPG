...
{
    [AddComponentMenu("UI/Recyclable Horizontal Scroll Rect", 50)]
    [DisallowMultipleComponent]
    public class RecyclableHorizontalScrollRect : RecyclableScrollRect
    {
        ...
        {
            direction = RecyclableScrollRectDirection.Horizontal;
            base.Awake();
