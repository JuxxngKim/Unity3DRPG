...
{
    [AddComponentMenu("UI/Recyclable Vertical Scroll Rect", 51)]
    [DisallowMultipleComponent]
    public class RecyclableVerticalScrollRect : RecyclableScrollRect
    {
        ...
        {
            direction = RecyclableScrollRectDirection.Vertical;
            base.Awake();
